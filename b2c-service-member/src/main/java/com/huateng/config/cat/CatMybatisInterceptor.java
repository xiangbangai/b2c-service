...
public class CatMybatisInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        Transaction t = Cat.newTransaction(SysConstant.CAT_SQL, methodName);

        Cat.logEvent(SysConstant.CAT_DATABASE, datasourceUrl);
        Cat.logEvent(SysConstant.CAT_METHOD, mappedStatement.getSqlCommandType().name().toLowerCase(), Message.SUCCESS, getSql(invocation, mappedStatement));
        try {
