...
public class DataSourceConfigDB3 {
    ...
    @Value("${spring.datasource.db3.jdbcUrl}")
    private String url;
    ...
    @Bean(name = "dataSourceTransactionManagerDb3")
    public DataSourceTransactionManager transactionManager(@Qualifier("dataSourceDb3") DataSource dataSource){
